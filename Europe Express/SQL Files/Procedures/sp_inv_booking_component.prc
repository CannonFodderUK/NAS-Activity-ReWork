...
CREATE OR REPLACE PROCEDURE sp_inv_booking_component
AS
   ...
   v_ttl_local_cost            f_booking_component.local_cost%TYPE;
   v_ttl_local_cost_tax        f_booking_component.local_cost_tax%TYPE;
   v_ttl_local_cost_gst        f_booking_component.local_cost_gst%TYPE;
   v_ttl_quote_price           f_booking_component.quote_price%TYPE;
   v_ttl_quote_display_price   f_booking_component.quote_display_price%TYPE;
   v_ttl_quote_price_tax       f_booking_component.quote_price_tax%TYPE;
   v_quote_price_gst           f_booking_component.quote_price_gst%TYPE;
   v_quote_price_enc           f_booking_component.quote_price_enc%TYPE;
   v_ttl_comm_per              f_booking_component.comm_per%TYPE;
   v_ttl_max_comm              f_booking_component.max_comm%TYPE;
   ...
   IS
      SELECT DISTINCT 0 bref_sk,
                      ...
                      0 - max_comm,
                      0 - ttl_local_cost,
                      0 - ttl_local_cost_tax,
                      0 - ttl_local_cost_gst,
                      0 - ttl_quote_price,
                      0 - ttl_quote_display_price,
                      0 - ttl_quote_price_tax,
      ...
      LOOP
         ...
         FETCH C001
            INTO v_bref_sk,
                 ...
                 v_max_comm,
                 v_ttl_local_cost,
                 v_ttl_local_cost_tax,
                 v_ttl_local_cost_gst,
                 v_ttl_quote_price,
                 v_ttl_quote_display_price,
                 v_ttl_quote_price_tax,
            ...
            LOOP
               ...
               THEN
                  ...
                  BEGIN
                     /**** < UPDATE Cursor Block > ****/
                     --
                     --              UPDATE f_booking_component SET
                     ---- INSERT UPDATE HERE
                     --              ;
                     --
                     v_update_ok := 'Y';
